...
*/}}
{{- define "surf-ais-screenshot.name" -}}
...
*/}}
{{- define "surf-ais-screenshot.fullname" -}}
...
*/}}
{{- define "surf-ais-screenshot.chart" -}}
...
*/}}
{{- define "surf-ais-screenshot.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "surf-ais-screenshot.fullname" .) .Values.serviceAccount.name }}
{{- else }}
